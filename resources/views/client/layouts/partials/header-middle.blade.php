<div class="container">
    ...
    <div class="header-right w-lg-max">
        ...
        <div class="header-contact d-none d-lg-flex pl-4 pr-4">
            <img alt="phone" src="{{ asset('assets/theme/client/images/phone.png') }}" width="30" height="30"
                class="pb-1">
            <h6>
                ...
                <div class="dropdownmenu-wrapper custom-scrollbar">
                    ...
                    <div class="dropdown-cart-products">
                        <div class="product">
                            ...
                            <figure class="product-image-container">
                                <a href="product.html" class="product-image">
                                    <img src="{{ asset('assets/theme/client/images/products/product-1.jpg') }}"
                        ...
                        <div class="product">
                            ...
                            <figure class="product-image-container">
                                <a href="product.html" class="product-image">
                                    <img src="{{ asset('assets/theme/client/images/products/product-2.jpg') }}"
                                        alt="product" width="80" height="80">
                                </a>
                        ...
                        <div class="product">
                            ...
                            <figure class="product-image-container">
                                <a href="product.html" class="product-image">
                                    <img src="{{ asset('assets/theme/client/images/products/product-3.jpg') }}"
                                        alt="product" width="80" height="80">
                                </a>
                                <a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
                            </figure>
