                    ...
                    <div class="product-default">
                        <figure>
                            <a href="{{ route('shop.detail', $product->slug) }}">
                                ...
                                <img src="{{ Storage::url($product->thumb_image) }}" width="50px" height="50px" alt="product" />
                                <img src="{{ Storage::url($product->thumb_image) }}" width="50px" height="50px" alt="product" />
                                @else
                                <img src="https://laravel.com/img/logomark.min.svg" width="50px" height="50px" alt="product" />
                                @endif
                            </a>
                    ...
                    <div class="owl-carousel widget-featured-products">
                        <div class="featured-col">
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-4.jpg') }}" width="75" height="75" alt="product" />
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-4-2.jpg') }}" width="75" height="75" alt="product" />
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-5.jpg') }}" width="75" height="75" alt="product" />
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-5-2.jpg') }}" width="75" height="75" alt="product" />
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-6.jpg') }}" width="75" height="75" alt="product" />
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-6-2.jpg') }}" width="75" height="75" alt="product" />
                                    </a>
                                </figure>
                                <div class="product-details">
                        ...
                        <div class="featured-col">
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-1.jpg') }}" width="75" height="75" alt="product" />
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-1-2.jpg') }}" width="75" height="75" alt="product" />
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-2.jpg') }}" width="75" height="75" alt="product" />
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-2-2.jpg') }}" width="75" height="75" alt="product" />
                                    </a>
                                </figure>
                                <div class="product-details">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-3.jpg') }}" width="75" height="75" alt="product" />
                                        <img src="{{ asset('assets/theme/client/images/products/small/product-3-2.jpg') }}" width="75" height="75" alt="product" />
                                    </a>
                                </figure>
                                <div class="product-details">
