            ...
            <div class="row">
                ...
                <div class="col-6 col-sm-4 col-md-3">
                    <div class="product-default">
                        <figure>
                            <a href="{{ route('shop.detail', 'ao-phong-nam-123') }}">
                                <img src="{{ asset($product['img_1']) }}" width="280" height="280" alt="product" />
                                <img src="{{ asset($product['img_2']) }}" width="280" height="280" alt="product" />
                            </a>
                        ...
                        <div class="product-details">
                            ...
                            <div class="price-box">
                                <span class="old-price">${{ $product['price_regular'] }}</span>
                        ...
                        <div class="owl-carousel widget-featured-products">
                            <div class="featured-col">
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="product.html">
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-4.jpg') }}"
                                                width="75" height="75" alt="product" />
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-4-2.jpg') }}"
                                                width="75" height="75" alt="product" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="product.html">
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-5.jpg') }}"
                                                width="75" height="75" alt="product" />
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-5-2.jpg') }}"
                                                width="75" height="75" alt="product" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="product.html">
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-6.jpg') }}"
                                                width="75" height="75" alt="product" />
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-6-2.jpg') }}"
                                                width="75" height="75" alt="product" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                            ...
                            <div class="featured-col">
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="product.html">
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-1.jpg') }}"
                                                width="75" height="75" alt="product" />
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-1-2.jpg') }}"
                                                width="75" height="75" alt="product" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="product.html">
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-2.jpg') }}"
                                                width="75" height="75" alt="product" />
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-2-2.jpg') }}"
                                                width="75" height="75" alt="product" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="product-default left-details product-widget">
                                    <figure>
                                        <a href="product.html">
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-3.jpg') }}"
                                                width="75" height="75" alt="product" />
                                            <img src="{{ asset('assets/theme/client/images/products/small/product-3-2.jpg') }}"
                                                width="75" height="75" alt="product" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
