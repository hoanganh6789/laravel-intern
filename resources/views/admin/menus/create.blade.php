...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Create Menu</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="position menu" name="position" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" placeholder="Nhập id của menu cha nếu đây là menu con" name="parent_id" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="/example/laravel" name="slug" class="form-control">
