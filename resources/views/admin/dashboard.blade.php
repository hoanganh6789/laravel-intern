...
@section('title', 'LuxChill DashBoard')
@section('content')
<div class="row mb-4">
    <div class="col-lg-12">
...
<div class="row">
        ...
        <div class="card mini-stats-wid">
            ...
            <div class="card-body border-top py-3">
                <p class="mb-0"> <span class="badge badge-soft-success me-1"><i
                            class="bx bx-trending-up align-bottom me-1"></i> 18.89%</span> Increase
                    last month</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3">
        <div class="card mini-stats-wid">
            ...
            <div class="card-body border-top py-3">
                <p class="mb-0"> <span class="badge badge-soft-success me-1"><i
                            class="bx bx-trending-up align-bottom me-1"></i> 24.07%</span> Increase
                    last month</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="carousel-item active" data-bs-interval="3000">
                            <div class="bg-light p-3 d-flex mb-3 rounded">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-0 text-muted"><i class="bx bx-map text-body align-middle"></i> Germany
                                    </p>
                                </div>
                                <div>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton11">
                                            <li><a class="dropdown-item" href="candidate-overview.html">View Details</a>
                                            </li>
                                            <li><a class="dropdown-item" href="dashboard-job.html#">Download CV</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-light p-3 d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-0 text-muted"><i class="bx bx-map text-body align-middle"></i> Cambodia
                                    </p>
                                </div>
                                <div>
                                    <div class="dropdown">
                            ...
                            <div class="bg-light p-3 d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-15 mb-2"><a href="candidate-overview.html"
                                            ...
                                            class="badge badge-soft-info">Freelance</span></h5>
                                    <p class="mb-0 text-muted"><i class="bx bx-map text-body align-middle"></i> Belgium
                                    </p>
                                </div>
                                <div>
                                    <div class="dropdown">
